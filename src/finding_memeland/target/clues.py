...
def _treasure_wording(guidance: str) -> str:
    ...
    relic's NAME" / "the RELIC'S ARTWORK". In this game the public word is
    THE TREASURE (Clue 1, reveal). Local to the target engine; the relic
    engine's own text is untouched."""
    def sub(m):
        art = m.group(1) or ""
